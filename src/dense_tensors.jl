...
function update_signature_horner_enzyme_svec!(
    A_tensor::Tensor{T,D,M}, 
...
function sig_enzyme_horner_svec(path_matrix::Matrix{Float64}, m::Int)
    ...
    @inbounds for i in 1:N-1
        ...
        update_signature_horner_enzyme_svec!(a, z, B1, B2)
    end
